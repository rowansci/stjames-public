...
from ..types import UUID, round_list, round_list_of_optionals
...
class NMRSpectroscopyWorkflow(MoleculeWorkflow):
    ...
    per_conformer_chemical_shifts: list[Annotated[list[float | None], AfterValidator(round_list_of_optionals(3))]] = []
    chemical_shifts: Annotated[list[float | None], AfterValidator(round_list_of_optionals(3))] = []
